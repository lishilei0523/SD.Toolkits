...
namespace SD.Toolkits.Common
{
    ...
    public static class Assert
    {
        ...
        #region # 断言字符串长度短于给定值 —— void IsShorterThan(string str, uint length...
        /// <summary>
        /// 断言字符串长度短于给定值
        /// </summary>
        /// <param name="str">字符串</param>
        ...
        #region # 断言字符串长度长于给定值 —— void IsLongerThan(string str, uint length...
        /// <summary>
        /// 断言字符串长度长于给定值
        /// </summary>
        /// <param name="str">字符串</param>
        ...
        #region # 断言数值在给定范围 —— void IsInRange(int value, int min, int max...
        /// <summary>
        /// 断言数值在给定范围
        /// </summary>
